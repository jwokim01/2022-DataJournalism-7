...
chart_data = pd.DataFrame({'임기':['14대','15대','16대','17대','18대','19대','20대','21대'],
                          '법률안 총계':[902,1951,2507,7489,13913,17822,24141,15322],
...
이번 프로젝트는 크게 두 부분으로 구성된다. 21대 국회 총 16,871건의 국회의원 발의안을 분석하여 첫째, ‘어떤 내용’과 '어떤 특성'의 법률안이 발의되었는지를 살펴본다. 이에 더해, 84,257건 의 뉴스 데이터를 분석한 결과를 토대로 이러한 법률 발의안을 21대 회기 동안의 사회 트렌 드와 비교해본다. 둘째, ‘누가’ 이러한 법률안을 발의하였는지를 살펴본다. 이 부분에서는 발의자인 국회의원의 소속 정당과 연령을 기준으로 어떤 법률안이 발의되는지를 살펴본다.
"""
)
